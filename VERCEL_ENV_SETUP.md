...
```
NEXT_PUBLIC_GIGESCROW_ADDRESS=0xTuDireccionDelContratoAqui
NEXT_PUBLIC_REPUTATION_TOKEN_ADDRESS=0xTuDireccionDelContratoAqui
NEXT_PUBLIC_STAKING_POOL_ADDRESS=0xTuDireccionDelContratoAqui
```
