  ...
  return (
    <section id="multistream" className="py-16 bg-gradient-to-b from-somnia-dark to-somnia-dark/95 relative overflow-hidden neural-bg">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {metrics.map((metric, idx) => (
              <div key={metric.label} className="text-center">
                ...
                <div className="text-white/70 uppercase tracking-wide text-sm">{metric.label}</div>
              </div>
            ))}
          </div>
        </motion.div>
        ...
        >
          <h3 className="text-3xl font-bold text-white mb-8 text-center">How MultiStream Works</h3>
