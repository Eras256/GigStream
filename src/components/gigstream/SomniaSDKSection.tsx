    ...
    <section id="somnia-sdk" className="py-20 bg-gradient-to-b from-somnia-dark/95 to-somnia-dark relative neural-bg overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            <Database className="w-12 h-12 text-somnia-cyan mx-auto drop-shadow-[0_0_20px_hsl(var(--somnia-cyan)/0.6)]" />
          </motion.div>
          ...
          {features.map((feature, idx) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className={`w-14 h-14 bg-gradient-to-br ${feature.color} rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-neural-glow`}>
        ...
        >
          <div className="backdrop-blur-xl bg-gradient-to-r from-somnia-purple/20 via-somnia-cyan/20 to-mx-green/20 border border-somnia-purple/30 rounded-2xl p-8 max-w-3xl mx-auto">
            <h3 className="text-2xl font-bold text-white mb-4">SDK Version & Integration</h3>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              <div className="text-center">
                <div className="text-3xl font-black text-somnia-cyan mb-2">v0.11.0</div>
                <div className="text-white/70 text-sm">SDK Version</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-black text-mx-green mb-2">100%</div>
                <div className="text-white/70 text-sm">TypeScript</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-black text-somnia-purple mb-2">Vitest</div>
                <div className="text-white/70 text-sm">Integration Tests</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-black text-scroll-gold mb-2">Hardhat</div>
                <div className="text-white/70 text-sm">Contract Dev</div>
              </div>
            </div>
            ...
            <Link href="https://docs.somnia.network" target="_blank" rel="noopener noreferrer">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-somnia-cyan to-somnia-purple rounded-xl text-white font-bold shadow-neural-glow"
              >
