            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/50 backdrop-blur-xl focus:outline-none focus:border-somnia-purple/50"
                />
              </div>
          ...
          >
            <div className="backdrop-blur-xl bg-white/5 rounded-2xl p-6 border border-white/10">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-to-br from-somnia-cyan/20 to-somnia-purple/20 rounded-xl flex items-center justify-center">
                  <Store className="w-5 h-5 text-somnia-cyan" />
                </div>
                <div>
                  <div className="text-2xl font-bold text-white">{jobsCount}</div>
                  <div className="text-white/60 text-sm font-mono">Total Jobs</div>
                </div>
              </div>
            </div>
            <div className="backdrop-blur-xl bg-white/5 rounded-2xl p-6 border border-white/10">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-to-br from-mx-green/20 to-emerald-400/20 rounded-xl flex items-center justify-center">
                  <Zap className="w-5 h-5 text-mx-green" />
                </div>
                <div>
                  <div className="text-2xl font-bold text-white">{allJobIds.length}</div>
                  <div className="text-white/60 text-sm font-mono">Available Now</div>
                </div>
              </div>
            </div>
            <div className="backdrop-blur-xl bg-white/5 rounded-2xl p-6 border border-white/10">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-to-br from-somnia-purple/20 to-mx-green/20 rounded-xl flex items-center justify-center">
                  <Plus className="w-5 h-5 text-somnia-purple" />
                </div>
                <div>
                  <div className="text-2xl font-bold text-white">Live</div>
                  <div className="text-white/60 text-sm font-mono">Real-time Updates</div>
                </div>
              </div>
            </div>
          </motion.div>
